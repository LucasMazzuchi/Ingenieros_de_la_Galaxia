...
('Saturno', 'Un coloso de nubes arremolinadas y tormentas. Un caos gigante de alta presión. Te acercás y los escáneres pierden la calibración, arrojando falsos positivos, como si dentro de esas tormentas colosales hubiera estructuras sólidas en movimiento.', 2, 139820, 24.7, -110, FALSE, 2, 5, 8, 6),
('C-48', 'Un infierno tóxico envuelto en densas nubes de ácido sulfúrico. La presión te aplasta si intentás bajar, pero las sondas marcan que hay siluetas flotando en la atmósfera superior, como si fueran plataformas fantasma.', 1, 12104, 8.8, 462, FALSE, 1, 2, 9, 6);
...
/*Mercurio (ID 5)*/
('Corazón de Caloris', 'El impacto no formó esta enorme cuenca; expuso lo que había debajo. Una bóveda forjada en una aleación que no figura en nuestros registros. La estructura sufrió un impacto cataclísmico, pero sigue intacta. Tenemos que tener cuidado con lo que podamos despertar si logramos abrirla.', 1, 1, 5),
('La Línea del Ocaso', 'En el terminador, la frontera entre el día abrasador y la noche helada, nos topamos con un cementerio de vehículos de exploración de origen alienígena. Sus sistemas están fundidos, como si hubieran intentado cruzar hacia el lado oscuro y un pulso defensivo los hubiera neutralizado al instante.', 2, 1, 5),
('Esferas del Norte', 'En los oscuros cráteres polares, esferas de composición desconocida flotan de forma estática a medio metro del suelo. Levitan mediante un campo magnético autónomo. Parecen ser minas de proximidad o boyas de contención olvidadas desde una guerra ancestral.', 3, 1, 5),

/*Júpiter (ID 6)*/
('El Ojo Inmóvil', 'La Gran Mancha Roja no es solo un ciclón constante. En el centro exacto del vórtice descansa una sombra colosal que permanece estática, desafiando los vientos de miles de kilómetros por hora. Parece ser una instalación suspendida soportando las peores condiciones climáticas imaginables.', 1, 1, 6),
('Resonancia Magnética', 'Entre los intensos cinturones de radiación ecuatorial navega una señal de auxilio que se repite en un bucle infinito. Logramos aislar la frecuencia y conseguimos un audio profundamente distorsionado, pero las cuerdas vocales que lo emiten no suenan humanas.', 2, 1, 6),
('Latido de Europa', 'La corteza de hielo cruje siguiendo un patrón rítmico, casi respiratorio. Lanzamos sondas acústicas y los ecos devuelven un sonido que se asemeja a una entidad titánica en letargo bajo el océano oscuro. Va a ser mejor que mantengamos el sigilo al perforar.', 3, 1, 6),

/*Plutón (ID 4)*/
('El Latido de Tombaugh', 'La enorme llanura de hielo de nitrógeno conocida como el "Corazón" de Plutón oculta un secreto bajo su superficie. Los sensores de profundidad detectaron una red geométrica perfecta emitiendo pulsos de calor controlados. Este sistema termodinámico parece ser el responsable de mantener el hielo en constante movimiento convectivo, borrando cualquier evidencia de impactos. Tenemos que perforar la corteza y escanear la fuente de energía antes de que los glaciares inicien un nuevo ciclo de congelamiento.', 1, 1, 4),
('Ecos de Caronte', 'Plutón y su luna más grande están anclados gravitacionalmente, mostrándose siempre la misma cara. Sin embargo, interceptamos un haz de microondas de alta frecuencia que rebota perpetuamente entre ambos cuerpos en un vacío perfecto. La señal no es ruido estático espacial; contiene secuencias matemáticas que se reescriben a sí mismas. Si logramos sintonizar los receptores de la nave, podríamos decodificar un antiguo relé de comunicaciones.', 2, 1, 4),
('Cenizas de Cthulhu', 'En la oscura y rojiza extensión ecuatorial de Plutón, el análisis espectral indica una concentración anormal de tolinas. Cuando nos acercamos, las cámaras revelaron que estos compuestos orgánicos no se formaron naturalmente por radiación; parecen ser los restos de una antigua mega-estructura sintética destrozada. Lo más inquietante es que, al entrar en contacto con los escudos electromagnéticos de nuestra nave, el polvo de la superficie comenzó a levitar y reorganizarse.', 3, 1, 4),

/*Venus (ID 7)*/
('Ciudades en la Bruma', 'Las sondas atmosféricas fueron destruidas por la presión, pero antes de apagarse transmitieron sombras estructurales. No están en la superficie, sino flotando estáticamente en la capa alta de nubes de ácido sulfúrico, desafiando la gravedad del planeta.', 1, 1, 7),
('El Faro de Maxwell', 'Maxwell Montes, la montaña más alta de Venus, no es solo roca volcánica. Su cumbre metálica funciona como un pararrayos gigantesco, absorbiendo la energía estática de la atmósfera para alimentar un pulso electromagnético que se dispara sin cesar hacia el espacio profundo.', 2, 1, 7),
('Tectónica Sintética', 'Venus no debería tener placas tectónicas, sin embargo, los radares muestran grietas perfectamente rectas formándose en las llanuras de lava. Estas fisuras se abren y cierran siguiendo un patrón lógico, como si el núcleo del planeta fuera en realidad un inmenso mecanismo recalentado.', 3, 1, 7);