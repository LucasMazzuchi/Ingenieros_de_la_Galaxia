...
import {validarEntrada, validarString, validarEntero, validarBool, validarFloat,
    validarFiltros, validarValorFiltro, validarRango, orden} from "./validaciones_errores.js";


// La función inicializa el diccionario de validadores y el de entrada para la entidad cuerpos celestes, valida la entrada mediante validarEntrada y llama a la
...
// La función inicializa los diccionarios con los validadores y los campos permitidos para filtrar en la entidad cuerpos celestes, valida que los filtros
...
export const validarFiltrosCuerpoCeleste = (req, res, next) => {
    ...
    if (erroresValores.length !== erroresPermitidos) {
    ...
    if (erroresRangos.length !== erroresPermitidos){
